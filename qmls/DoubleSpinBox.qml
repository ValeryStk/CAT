...
Control {
    ...
    property double from: 0.0001
    property double to: 1000.0
    property double stepSize: 0.0001
    property bool editable: true
    property bool isTooltip:_mouseAreaDoubleSpinbox.containsMouse
    ...
    // Custom properties
    property int decimals: 4                  //!< Desired precision
